class ResponsesController < ApplicationController
  ...
  private
    ...
    def response_params
      params.require(:response).permit(:email, :response, :platform, :reviewer)
    end
end
